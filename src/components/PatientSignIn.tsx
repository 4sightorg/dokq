...
const PatientSignIn: React.FC = React.memo(() => {
      ...
      switch (error.code) {
        ...
        default:
          if (
            ...
            errorMsg =
              'Firebase configuration error. Please check your API key configuration.';
  ...
  const handleForgotPassword = useCallback(async () => {
    ...
    if (!email) {
      showError(
        'Please enter your email address first, then click "Forgot your password?"'
      );
      emailInputRef.current?.focus();
      return;
    }
  ...
  const handleSocialSignIn = useCallback(
    (platform: string) => {
      ...
      showError(
        `${platform} sign-in is not implemented yet. Please use email or Google sign-in.`
      );
    },
    [showError]
  );
  ...
  return (
    <div
      className='signup-container centered-container'
      role='main'
      ...
      <div className='centered-section'>
        ...
        <div className='signup-content'>
          <div className='signup-header'>
            ...
            <p>
              New to DokQ?{' '}
              <a href='/patient-sign-up' className='login-link'>
                Sign up
              </a>
            </p>
          </div>
          ...
          >
            ...
            <button
              ...
              aria-describedby={
                !isFormValid ? 'form-validation-help' : undefined
              }
            >
              <span
                className='btn-text'
