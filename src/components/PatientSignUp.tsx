...
const PatientSignUp: React.FC = React.memo(() => {
  ...
  const [isGoogleSignUpInProgress, setIsGoogleSignUpInProgress] =
    useState(false);
    ...
    async (e: React.FormEvent) => {
      ...
      try {
        ...
        if (userCredential.user) {
          ...
          // Create patient document in Firestore (using same app db)
          try {
            ...
            const patientData = {
              ...
              role: 'patient',
              uniquePatientId: userCredential.user.uid,
              personalInfo: {
                firstName: formData.firstName,
                lastName: formData.lastName,
    ...
    try {
      ...
      switch (error.code) {
        ...
        case 'auth/account-exists-with-different-credential':
          errorMsg =
            'An account already exists with this email using a different sign-in method. Please try signing in instead.';
          break;
      ...
      <div className='centered-section'>
        ...
        <div className='signup-content'>
          <div className='signup-header'>
            ...
            <p>
              Already know DokQ?{' '}
              <a href='/patient-sign-in' className='login-link'>
                Log in
              </a>
            </p>
          </div>
