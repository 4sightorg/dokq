...
const PatientSignUp: React.FC = React.memo(() => {
      ...
      if (userCredential.user) {
        ...
        try {
          ...
          try {
            ...
            const created = await getDoc(doc(db, 'patients', userCredential.user.uid))
            console.log('🔎 Verification readback exists:', created.exists())
            if (!created.exists()) {
              console.warn('⚠️ Verification readback failed: document not found right after setDoc')
            } else {
  ...
  return (
    <div className="signup-container centered-container" role="main" aria-label="Patient Sign Up">
      ...
      <div className="centered-section">
        ...
        <div className="signup-content">
          <div className="signup-header">
            ...
            <p>Already know DokQ? <a href="/patient-sign-in" className="login-link">Log in</a></p>
          </div>
