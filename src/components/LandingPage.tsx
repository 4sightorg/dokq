...
const LandingPage: React.FC = () => {
  ...
  const initializeAccessibility = () => {
    announceToScreenReader('DokQ healthcare platform loaded. Use Tab to navigate.')
  }
        ...
        <div className="container">
          <div className="cta-content">
            <div className="cta-text">
              ...
              <p>Join DokQ and connect with thousands of patients across the Philippines. Streamline your practice with our comprehensive healthcare platform.</p>
