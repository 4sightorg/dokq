...
export function createFacilityDocument(
  user: any,
  additionalData?: any
...
export function updatePatientPersonalInfo(
  userId: string,
  personalInfo: PersonalInfo
): Promise<boolean>;
export function updatePatientMedicalInfo(
  userId: string,
  medicalInfo: MedicalInfo
): Promise<boolean>;
export function updatePatientSettings(
  userId: string,
...
export function removeMedicalCondition(
  userId: string,
  category: string,
  condition: string
): Promise<boolean>;

export function addConsultationHistory(
  userId: string,
...
export function updateAppointment(
  ...
  updatedAppointmentData: any
): Promise<boolean>;
export function updateAppointmentByFacility(
  appointmentId: string,
  patientId: string,
  updatedAppointmentData: any,
  facilityId: string
...
export function getFacilityAppointments(
  facilityId: string
): Promise<AppointmentData[]>;
...
export function listenToPatientData(
  userId: string,
  callback: (data: PatientData | null) => void
): () => void;
export function listenToFacilityAppointments(
  facilityId: string,
